...
useServer | | false | This parameter only works when the binder is kafka. It takes all the hosts under the server section and concatinates them to a set of brokers.
