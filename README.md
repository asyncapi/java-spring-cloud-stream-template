...
useServers | | false | This parameter only works when the binder is kafka. It takes all the urls under the server section and concatenates them to a set of brokers.
