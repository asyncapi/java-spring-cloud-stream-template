...
class ApplicationModel {
   ...
   * and attempt to apply a name to objects
  ...
  setupClassNames(schema, name) {
    ...
    if (props) {
      ...
      if (schema.type === "object" && this.isAnonymousSchema(schemaId)) {
      ...
      propNames.forEach(propName => {
        ...
        if (schemaObject.type === "object" && this.isAnonymousSchema(schemaId)) {
